(function() {
  ...
  Database = (function() {
    ...
    Database.prototype.useNTLM = function(domain, username, password) {
      var ntlmaps, user_pwd,
        _this = this;
      if (this.ntlm != null) {
        console.log("already spawned ntlm process: " + this.ntlm.pid);
        return;
      }
      user_pwd = new Buffer("" + username + ":" + password).toString('base64');
      this.setAuthorization("Basic " + user_pwd);
      console.log(user_pwd);
      ntlmaps = spawn('python', ["" + __dirname + "/../deps/ntlmaps/main.py", "--domain=" + domain, "--password=passed_in_auth_header", "--port=5555"]);
      this.ntlm = ntlmaps;
      ...
      return ntlmaps.on('exit', function(code) {
        _this.ntlm = null;
    ...
    Database.prototype.apiCall = function(verb, url, bodyOrReadableStream, headers, cb) {
      ...
      if (this.ntlm != null) req['proxy'] = "http://localhost:5555";
